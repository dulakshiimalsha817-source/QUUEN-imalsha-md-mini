...
const config = {
    ...
    RCD_IMAGE_PATH: 'https://i.ibb.co/RTkrBH1t/tourl-1762569900001.jpg',
...
socket.downloadAndSaveMediaMessage = async(message, filename, attachExtension = true) => {
   ...
   case 'alive': {
    ...
    const captionText = `
❲ Qᴜᴜᴇɴ ɪᴍᴀʟꜱʜᴀ ᴍɪɴɪ ʙᴏᴛ ᴀʟɪᴠᴇ ꜱᴛᴀᴛᴜꜱ 🔥  ❳
...
`;
                    ...
                    sections: [
                        {
                            ...
                            rows: [
                                ...
                                {
                                    title: '❲ 𝘖𝘞𝘕𝘌𝘙 👻 ❳',
                                    description: 'Qᴜᴜᴇɴ ɪᴍᴀʟꜱʜᴀ ᴍɪɴɪ ʙᴏᴛ 🔥',
    ...
    await socket.sendMessage(m.chat, {
        ...
        headerType: 1,
        viewOnce: true,
        image: { url: "https://i.ibb.co/RTkrBH1t/tourl-1762569900001.jpg" },
        caption: `Qᴜᴜᴇɴ ɪᴍᴀʟꜱʜᴀ ᴍɪɴɪ ʙᴏᴛ 🔥\n\n${captionText}`,
    }, { quoted: msg });
...
case 'setting': {
	...
	settingsText += `> *𝙿𝙾𝚆𝙴𝚁𝙳 𝙱𝚈 𝚂𝙰𝙽𝙽𝚄 𝚇*`;
...
case 'ping': {
    ...
    break;
		        ...
		        case 'owner': {
    const ownerNumber = '+94785893445';
    const ownerName = 'QUUEN IMALSHA ';
    const organization = '*QUUEN IMALSHA MINI BOT OWNER 👾*';
    ...
    try {
        ...
        await socket.sendMessage(from, {
            text: `* 💝 QUUEN IMALSHA MINI BOT OWNER*\n\n👨‍🔧 Name: ${ownerName}\n💭 ηυмвєя ➥ ${ownerNumber}\n\n> Qᴜᴜᴇɴ ɪᴍᴀʟꜱʜᴀ ᴍɪɴɪ ʙᴏᴛ 🔥`,
            contextInfo: {
        ...
        if (!id) {
           ...
           if(!searchResults?.results?.length) return await socket.sendMessage(from, {
             ...
             text: '*📛 Please enter valid you tube song name or url.*'
                ...
                const caption = `*🎧 \`QUUEN IMALSHA MINI SONG DOWNLOADER\`*\n\n` +
		  `*┏━━━━━━━━━━━━━━━*\n` +
	      `*┃ 📌 \`тιтℓє:\` ${title || "No info"}*\n` +
...
await socket.sendMessage(sender, { react: { text: '📥', key: msg.key } });
    ...
    try {
        ...
        await socket.sendMessage(sender, {
            ...
            mimetype: "audio/mpeg",
            fileName: ` QUUEN IMALSHA  MINI BOT mp3 💚💆‍♂️🎧`
        }, { quoted: msg });
...
case 'fb': {
  ...
  try {
    ...
    const url = args[0];
    const caption = `🎬💚 * QUUEN IMALSHA  MINI BOT FB DOWNLOADER*

💚 *Title:* ${fb.title}
🧩 *URL:* ${url}

>  QUUEN IMALSHA  MINI BOT 💚🔥
...
👨‍🔧💚 *¢ℓι¢к вυттση нєαяє*`;
    ...
    await socket.sendMessage(from, {
      ...
      caption: caption,
      footer: '💚 QUUEN IMALSHA MINI BOT FB DOWNLOADER 💚',
      buttons: templateButtons,
      headerType: 4
    }, { quoted: msg });
...
case 'xnxxdlRes': {
  ...
  break;
                    ...
                    if (args.length === 0) {
                        return await socket.sendMessage(sender, {
                            text: '❗ Please provide a channel JID.\n\nExample:\n.cf 120363405600029703@newsletter'
                        });
                    }
...
case 'tiktokdl': {
    try {
        ...
        const titleText = '*QUUEN-IMALSHA  MINI TIKTOK DOWNLOADER*';
        const content = `┏━━━━━━━━━━━━━━━━\n` +
...
case 'active': {
    ...
    let message = `*⚡QUUEN IMALSHA  MINI ACTIVE BOT LIST ⚡*\n`;
    message += `━━━━━━━━━━━━━━━\n`;
...
router.get('/ping', (req, res) => {
    res.status(200).send({
        status: 'active',
        message: '👻 Qᴜᴜᴇɴ ɪᴍᴀʟꜱʜᴀ ᴍɪɴɪ ʙᴏᴛ  is running',
...
process.on('uncaughtException', (err) => {
    ...
    exec(`pm2 restart ${process.env.PM2_NAME || 'QUEEN-IMALSHA-MINI-main'}`);
});
